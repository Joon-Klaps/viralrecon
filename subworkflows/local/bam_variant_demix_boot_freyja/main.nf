include { FREYJA_VARIANTS   } from '../../../modules/local/freyja/variants'
include { FREYJA_UPDATE     } from '../../../modules/local/freyja/update'
include { FREYJA_DEMIX      } from '../../../modules/local/freyja/demix'
include { FREYJA_BOOT       } from '../../../modules/local/freyja/boot'
